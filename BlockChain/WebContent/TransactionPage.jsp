...
<div id="content">
 ...
 <form action="profileupdate" enctype="multipart/form-data"	method="post">
	       ...
	       <tr>
			...
			<td width="18%"><h3>Mount Donate</h3> </td>
			<td width="18%"><h3>Transaction</h3> </td>
			  </tr>
			...
			while(resultset.next())
             {
              ...
              <td> <%= resultset.getString(1) %> </td>
               <td> <%= resultset.getString(2) %> </td>
                ...
                <td> <a href="UserStatusController?candidateid=<%=resultset.getString(1)%>"><input type="button" name="Turn On" value="View" class="btn btn-info"></a></td>
               </tr>
